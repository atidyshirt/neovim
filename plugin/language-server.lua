vim.pack.add({
    ...
    { src = "https://github.com/b0o/SchemaStore.nvim", opt = true },
    { src = "https://github.com/folke/lazydev.nvim", opt = true },
    { src = "https://github.com/cwrau/yaml-schema-detect.nvim", opt = true },
